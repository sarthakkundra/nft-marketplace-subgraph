...
export class NftMarketplace__s_listingsResult {
  value0: Address;
  value1: BigInt;
...
export class NftMarketplace extends ethereum.SmartContract {
  ...
  s_listings(
    param0: Address,
    param1: BigInt,
  ): NftMarketplace__s_listingsResult {
    let result = super.call(
      "s_listings",
      "s_listings(address,uint256):(address,uint256)",
      [
    ...
    return new NftMarketplace__s_listingsResult(
      result[0].toAddress(),
      result[1].toBigInt(),
    );
  }
  ...
  try_s_listings(
    param0: Address,
    param1: BigInt,
  ): ethereum.CallResult<NftMarketplace__s_listingsResult> {
    let result = super.tryCall(
      "s_listings",
      "s_listings(address,uint256):(address,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new NftMarketplace__s_listingsResult(
        value[0].toAddress(),
        value[1].toBigInt(),
      ),
    );
